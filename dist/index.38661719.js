...
parcelHelpers.export(exports, "xmlRequest", ()=>xmlRequest
);
...
function showUser(data) {
    ...
    const lastName = data.getElementsByTagName('lastname')[0].attributes.value.value;
    const userNameElement = document.createElement('p');
    const userName = document.createTextNode(`${firstName} ${lastName}`);
    userDiv.appendChild(userName);
}
async function xmlRequest() {
    _axiosDefault.default.create({
        baseURL: `https://cors-anywhere.herokuapp.com/https://www.boardgamegeek.com/xmlapi2/user?name=kernowekya`,
        timeout: 1000
    });
    _axiosDefault.default.get(`https://cors-anywhere.herokuapp.com/https://www.boardgamegeek.com/xmlapi2/user?name=kernowekya`).then((xml)=>{
...
},{}]},["5UGAA","7BQdY"], "7BQdY", "parcelRequire3f43")
