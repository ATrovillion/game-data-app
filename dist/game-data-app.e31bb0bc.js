...
var baseEndpoint = 'https://www.boardgamegeek.com/xmlapi2/';
var proxy = "https://cors-anywhere.herokuapp.com/";
var content = document.querySelector('.user');
...
function _fetchUser() {
  _fetchUser = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(userName) {
    var headers, data, parser, xmlDoc;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return fetch("".concat(proxy).concat(baseEndpoint, "user?name=").concat(userName), {
              headers: headers
            });
...
function xmlRequest() {
  return _xmlRequest.apply(this, arguments);
}

function _xmlRequest() {
  _xmlRequest = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _axios.default.get("https://cors-anywhere.herokuapp.com/https://www.boardgamegeek.com/xmlapi2/user?name=kernowekya").then(function (xml) {
              var doc = new DOMParser().parseFromString(xml.data, 'text/xml');
              console.log(doc);
            });
...
//# sourceMappingURL=/game-data-app.e31bb0bc.js.map